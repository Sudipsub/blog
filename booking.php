            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="car">Normal Bus</label> &nbsp;
                      <label><input type="radio" name="type" value="bus">Tour Bus</label> &nbsp;
                      <label><input type="radio" name="type" value="bus">Safari Bus</label> &nbsp;
                      <label><input type="radio" name="type" value="bus">Delux Bus</label>
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>Date of Requirement</b></span>
                      <input id="req_date" type="text" class="form-control" name="req_date" placeholder="Day the Bus is needed" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="return_date" type="text" class="form-control" name="return_date" placeholder="Day the Bus is returned" required>
                    ...
                    <div class="input-group">
                      ...
                      <input id="destination" type="text" class="form-control" name="destination" placeholder="Bus Destination" required>
                    </div>
                    <br>
