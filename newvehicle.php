                ...
                <br> 
                 ...
                 <div class="input-group">
                  ...
                  <label class="radio-inline">
                      <input type="radio" name="type" value="bus">Normal Bus
                    </label>
                <label class="radio-inline">
                  <input type="radio" name="type" value="tour">Tour Bus
                </label>
                <label class="radio-inline">
                  <input type="radio" name="type" value="delux">Delux Bus
                </label>
                </div>
                <br> 
